...
function BareInput(props: BareInputProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      />
      <div
        className="font-roboto flex h-4 w-24 flex-row items-center justify-center rounded-2xl border border-input-border-color bg-input p-4 text-center text-xl text-input-text"
