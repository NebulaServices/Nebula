...
export function Header() {
	...
	return (
		<div id="navbar" className="h-16 px-4 bg-navbar-color flex flex-row items-center justify-between">
			<a href="/" className="flex flex-row items-center w-1/2">
				<img src="/logo.png" className="h-16 w-16 hover:rotate-[360deg] transition-all duration-1000" />
			...
			<div className="w-1/2">
				<div className="flex flex-row justify-end items-center">
					<a href="/games" class="p-4 flex flex-row items-center">
					...
					<a href="/settings" class="p-4 flex flex-row items-center">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" style="width: 23px" >
					...
					<a href="https://discord.gg/unblocker" target="_blank" class="p-4 flex flex-row items-center">
						<svg style="width: 23px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" >
							<path style="fill: #ffffff00" stroke-linecap="round" stroke-linejoin="round" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" />
						</svg>
